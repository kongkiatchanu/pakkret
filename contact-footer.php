    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="logo_contact col-12 col-lg-4">
                <img class="local_contact shadow-drop-bottom rounded-circle" src="assets/image/<?= $icon; ?>" alt="">
            </div>
...
<footer class="footer">
    ...
    <?php }else{ ?>
        ...
        <p class="page_views fade_in float-sm-right mb-0"> <?php include('assets/js/google_repoting.php'); ?> </p>
    <?php } ?>
</footer>